...
private void init() {
    ...
    try {
        ...
        System.out.println("Anmeldung bei Twitter erfolgreich. Angemeldeter Benutzer: " + twitter.userOperations().getScreenName());
...
public void updateStatus(String statusText) throws Exception {
   // Versucht, den Tweet zu posten oder "behandelt" Fehler durch Ausgabe von Meldungen in der Konsole
    try {
        ...
        System.out.println("---------- Letzter geposteter Tweet: " + timelineOperations.getUserTimeline(1).get(0).getText());
    } catch (ApiException e) {
